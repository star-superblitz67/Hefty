...
## 🛠️ System Architecture (How I Built It)
...
Because this project is a high-speed **IP Core**, the I/O ports do not map to physical copper pins on the FPGA package (like LEDs or buttons). Instead, the I/O interfaces map to standard internal FPGA buses:
